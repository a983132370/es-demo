...
//        return restClientProperties.getUris();
//    }
    /**
     * 创建索引库
     *
    ...
    public Object doIndex() throws IOException {
        ...
        .startObject()
            ...
            .endObject()
        .endObject();
        createIndexRequest.mapping("product", builder);
        //创建索引操作客户端
    ...
    public Object save() throws IOException {
        ...
        List<DocWriteResponse.Result> resultList = new ArrayList<>();
        for (int i =0 ; i < length;i++){
            ...
            //指定索引文档内容
            indexRequest.source(JsonUtils.toJson(product), XContentType.JSON);
            //索引响应对象
...
//        });
    ...
    public Object del(@PathVariable("id") String id) throws IOException {
        DeleteRequest request = new DeleteRequest("product", "product", id);
    ...
    public Object getOne(@PathVariable("id") String id) throws IOException {
        GetRequest request = new GetRequest("product").type("product").id(id);
        GetResponse response = esClient.get(request, RequestOptions.DEFAULT);
        if(response.isExists()){
            return JsonUtils.toObject(response.getSourceAsString(), Product.class);
        };
        return response;
    }
...
//        searchSourceBuilder.fetchSource(new String[]{"name","price"}, new String[]{});
     ...
     */
    @GetMapping("/findPage")
    public Object findPage() throws IOException {
        SearchRequest searchRequest = new SearchRequest("product");
        searchRequest.types("product");
        SearchSourceBuilder searchSourceBuilder = new SearchSourceBuilder();
        searchSourceBuilder.query(QueryBuilders.matchAllQuery());
    ...
    public Object termQuery(String name) throws IOException {
        SearchRequest searchRequest = new SearchRequest("product");
        searchRequest.types("product");
        SearchSourceBuilder searchSourceBuilder = new SearchSourceBuilder();
...
//        searchSourceBuilder.fetchSource(new String[]{"name","price"}, new String[]{});
    ...
    public Object multiQuery(String text) throws IOException {
        SearchRequest searchRequest = new SearchRequest("product");
        searchRequest.types("product");
        SearchSourceBuilder searchSourceBuilder = new SearchSourceBuilder();
    ...
    public Object boolQuery(String text) throws IOException {
        SearchRequest searchRequest = new SearchRequest("product");
        searchRequest.types("product");
        SearchSourceBuilder searchSourceBuilder = new SearchSourceBuilder();
        //multiQuery
    ...
    public Object filterQuery(String text) throws IOException {
        SearchRequest searchRequest = new SearchRequest("product");
        searchRequest.types("product");
        SearchSourceBuilder searchSourceBuilder = new SearchSourceBuilder();
        //布尔查询
    ...
    public Object sortQuery(String text) throws IOException {
        SearchRequest searchRequest = new SearchRequest("product");
        searchRequest.types("product");
        SearchSourceBuilder searchSourceBuilder = new SearchSourceBuilder();
        //布尔查询
        ...
        searchSourceBuilder.query(boolQueryBuilder);
        //source源字段过虑,指定结果中所包括的字段有哪些
//        searchSourceBuilder.fetchSource(new String[]{"name","describe","price","id"}, new String[]{});
        searchRequest.source(searchSourceBuilder);
        SearchResponse response = getSearchResponse(searchRequest);
        return response;
    }
